...
export interface PluginMuxVideoUploaderMuxAsset extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<"plugin::mux-video-uploader.mux-asset", "oneToOne", "admin::user"> &
      Attribute.Private;
    updatedBy: Attribute.Relation<"plugin::mux-video-uploader.mux-asset", "oneToOne", "admin::user"> &
      Attribute.Private;
  };
}
