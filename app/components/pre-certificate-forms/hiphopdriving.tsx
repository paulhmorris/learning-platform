...
import { FormApi, ValidatedForm } from "@rvf/react-router";
...
export type HipHopDrivingCertificationValues = z.input<typeof hipHopDrivingCertificationSchema>;
...
export function emptyHipHopDrivingCertificationValues(userProfile: UserProfileData): HipHopDrivingCertificationValues {
  return {
...
export function HiphopDrivingPreCertificateForm({ userProfile }: { userProfile: UserProfileData }) {
  return (
    <ValidatedForm
      ...
      defaultValues={emptyHipHopDrivingCertificationValues(userProfile)}
    >
      {(form) => (
        <>
          <legend>
...
export function HiphopDrivingPreCertificateFields({
  form,
}: {
  form: FormApi<HipHopDrivingCertificationValues>;
}) {
  return (
