...
const schema = withZod(z.object({ resetId: z.string() }));
    ...
    <div className="max-w-screen-sm space-y-8">
      ...
      <div className="max-w-64 space-y-1">
        ...
        <fetcher.Form method="post" action="/api/reset-password">
          ...
          <AdminButton type="submit" variant="link" className="-ml-3.5 w-auto" disabled={fetcher.state !== "idle"}>
